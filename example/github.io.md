...
<span class="nv">$pdo</span><span class="o">-&gt;</span><span class="na">query</span><span class="p">(</span><span class="s2">&#34;SELECT name FROM users WHERE id = &#34;</span> <span class="o">.</span> <span class="nv">$_GET</span><span class="p">[</span><span class="s1">&#39;id&#39;</span><span class="p">]);</span> <span class="o">//</span> <span class="o">&lt;--</span> <span class="nx">NO</span><span class="o">!</span></code></pre>
...
<pre><code><span class="nt">&lt;ul&gt;</span>
<span class="cp">&lt;?php</span>
...
<pre><code><span class="cp">&lt;?php</span> <span class="k">foreach</span> <span class="p">(</span><span class="nv">$fooList</span> <span class="k">as</span> <span class="nv">$row</span><span class="p">)</span><span class="o">:</span> <span class="cp">?&gt;</span>
...
<pre><code><span class="cp">&lt;?php</span> <span class="c1">// user_profile.php ?&gt;
</span>
...
<pre><code><span class="cp">&lt;?php</span> <span class="c1">// template.php ?&gt;
</span>
...
<pre><code><span class="w">$ </span><span class="nc">php</span><span class="kv"> -a
</span>php &gt; echo $foo;
...
<pre><code><span class="w">$ </span><span class="nc">python</span><span class="kv">
</span>&gt;&gt;&gt; print foo
...
<pre><code><span class="py">xdebug.scream</span> <span class="p">=</span> <span class="s">On</span></code></pre>
...
<pre><code><span class="py">display_errors</span> <span class="p">=</span> <span class="s">On</span>
...
<pre><code><span class="py">display_errors</span> <span class="p">=</span> <span class="s">Off</span>
...
<pre><code><span class="err">docker run -d --name my-php-webserver -p 8080:80 -v /path/to/your/php/files:/var/www/html/ php:apache</span></code></pre>
